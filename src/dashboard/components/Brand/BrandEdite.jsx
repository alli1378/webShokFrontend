...
import {getUsersMain,getAllCategory,getBrandUpdate,handleBrandUpdate,getAllbrand} from '../../../actions/Dashboard'
import {} from '../../../actions/Dashboard'
function BrandUpdate({match,brand,history}) {
    ...
    const handleSubmit=event=>{
        ...
        try{
            ...
            dispatch(handleBrandUpdate(data,match.params.id))   
            // dispatch(getBrandUpdate(data,match.params.id))   
            // console.log(match);
